def adjust_parameters_for_faster_lap_25_percent_speed(file_path):
    ...
    for line in lines:
        ...
        if stripped_line.startswith("- speed:"):
            ...
            new_speed = speed * 1.25  # Increase by 25%
        ...
        # Adjust throttle to be closer to maximum without maxing out
            ...
            new_throttle = min(throttle * 1.01, 100)  # Increase by 10%, but cap at 100
    ...
    output_file_path = file_path.replace(".asset", "throttle05_faster_lap_25_percent_speed.asset")
    with open(output_file_path, 'w') as file:
        file.writelines(modified_lines)
    return output_file_path
# Adjusting parameters for a potentially faster lap time with 25% speed increase
faster_lap_file_path_25_percent_speed = adjust_parameters_for_faster_lap_25_percent_speed(
    '2022-07-27 20.00.32 UTC 05.05.920 ideal_autopilot.asset')
